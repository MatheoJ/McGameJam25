...
public class Cercle : MonoBehaviour
{
    ...
    void MoveToGaussianPoint(Transform player, NavMeshAgent agent, float meanDistance, float stdDevDistance)
    {
        ...
        // V�rifier si le point est valide sur le NavMesh
        NavMeshHit hit;
